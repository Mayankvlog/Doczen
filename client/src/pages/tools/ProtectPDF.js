  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      if (data.blobUrl) {
        ...
        setDownloadName(data.filename || 'protected.pdf');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-primary-50/30 to-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {result && !successMessage && (
          <div className="mt-6">
            <ResultCard result={result} onReset={() => { setResult(null); setFile(null); setPassword(''); setConfirmPassword(''); setSuccessMessage(''); }} action="protected with password" />
          </div>
        )}
      </div>
    </div>
