...
export default function ToolCard({ icon, title, description, link, color = 'bg-indigo-100' }) {
  return (
    <Link
      to={link}
    ...
    >
      <div className={`w-12 h-12 flex items-center justify-center rounded-xl text-xl ${color}`}>
        {icon}
      </div>
